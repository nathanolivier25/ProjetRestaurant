...
namespace Launcher
{
    class RestaurantLauncher
    {
        ...
        public void startPeople()
        {
            ...
            exchanger_desk = new ExchangerDesk(new TCP.TCP(TCP.TCP.Mode.Client), Side.Room);
            ...
            HeadWaiter head_waiter_1 = new HeadWaiter(new StrategyHeadWaiter(), this.bdd_connection, exchanger_desk, 1);
            HeadWaiter head_waiter_2 = new HeadWaiter(new StrategyHeadWaiter(), this.bdd_connection, exchanger_desk, 2);
